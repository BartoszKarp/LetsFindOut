package pl.karpiuu.letsfindout.domain.question;
...
import pl.karpiuu.letsfindout.domain.common.dto.StatisticsDto;
...
public interface QuestionRepository extends JpaRepository<Question, UUID> {
    ...
    @Query(value = "select new pl.karpiuu.letsfindout.domain.common.dto.StatisticsDto(count(q), count(a)) from Question q join q.answers a")
